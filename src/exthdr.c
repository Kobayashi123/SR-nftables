...
const struct exthdr_desc exthdr_rt4 = {
	...
	.templates      = {
		...
		[RT4HDR_SID_0]		= RT4_FIELD("sid[0]", ip6r4_segments[0], &ip6addr_type),
		[RT4HDR_SID_0 + 1]	= RT4_FIELD("sid[1]", ip6r4_segments[1], &ip6addr_type),
		[RT4HDR_SID_0 + 2]	= RT4_FIELD("sid[2]", ip6r4_segments[2], &ip6addr_type),
		[RT4HDR_SID_0 + 3]	= RT4_FIELD("sid[3]", ip6r4_segments[3], &ip6addr_type),
		[RT4HDR_SID_0 + 4]	= RT4_FIELD("sid[4]", ip6r4_segments[4], &ip6addr_type),
		[RT4HDR_SID_0 + 5]	= RT4_FIELD("sid[5]", ip6r4_segments[5], &ip6addr_type),
		[RT4HDR_SID_0 + 6]	= RT4_FIELD("sid[6]", ip6r4_segments[6], &ip6addr_type),
		[RT4HDR_SID_0 + 7]	= RT4_FIELD("sid[7]", ip6r4_segments[7], &ip6addr_type),
		[RT4HDR_SID_0 + 8]	= RT4_FIELD("sid[8]", ip6r4_segments[8], &ip6addr_type),
		[RT4HDR_SID_0 + 9]	= RT4_FIELD("sid[9]", ip6r4_segments[9], &ip6addr_type),
		[RT4HDR_SID_0 + 10]	= RT4_FIELD("sid[10]", ip6r4_segments[10], &ip6addr_type),
		// ...
	},
};
